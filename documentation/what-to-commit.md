...
| `narrativetrace-output/manifest.json` | No | Scenario → artifact index, plus the run's own `id`/`name` *(since 0.1.3)* — regenerated every run |

...
| [Habilidades de agente](es/habilidades-de-agente.md) | `narrativetrace-doctor`, una habilidad de agente fina y de solo lectura sobre `npx @narrativetrace/cli doctor` |
